        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate="" method="post" action="{{ route('nonmuslims.update', $nonmuslim->id) }}"
                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text" name="title"
                                        required="" value="{{ old('title') ? old('title') : $nonmuslim->title }}"/>
                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea  id="editor1" cols="30" rows="10" class="form-control" id="validationCustom03" type="text" name="content" required="required">{{ $nonmuslim->content }}</textarea>
                                    <div class="valid-feedback">{{ __('validation.valid_feedback') }}</div>
                                    <div class="invalid-feedback">{{ __('validation.invalid_feedback') }}</div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-select" data-live-search="true"
                                        ...
                                        @foreach ($languages as $language)
                                            <option {{ $nonmuslim->language_id == $language->id ? 'selected'  : ''}}
