        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate="" method="post" action="{{ route('translations.store') }}"
                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-select" data-live-search="true"
                                        ...
                                        <option {{ old('name') == 'home' ? 'selected' : '' }} value="home">Home</option>
                                        <option {{ old('name') == 'aboutTheWriter' ? 'selected' : '' }} value="aboutTheWriter">About The Writer</option>
                                        <option {{ old('name') == 'products' ? 'selected' : '' }} value="products">Products</option>
                                        <option {{ old('name') == 'nonMuslimViews' ? 'selected' : '' }} value="nonMuslimViews">NonMuslimViews</option>
                                        <option {{ old('name') == 'blog' ? 'selected' : '' }} value="blog">Blog</option>
                                        <option {{ old('name') == 'contact' ? 'selected' : '' }} value="contact">Contact</option>
