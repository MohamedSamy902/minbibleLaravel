        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate="" method="post" action="{{ route('blogs.update', $blog->id) }}"
                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text" name="title"
                                        required="" value="{{ old('title') ? old('title') : $blog->title }}"/>
                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea  id="editor1" cols="30" rows="10" class="form-control" id="validationCustom03" type="text" name="content" required="required">{{ $blog->content }}</textarea>
                                    <div class="valid-feedback">{{ __('validation.valid_feedback') }}</div>
                                    <div class="invalid-feedback">{{ __('validation.invalid_feedback') }}</div>
                                </div>
                            </div>
                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea  id="editor2" cols="30" rows="10" class="form-control" id="validationCustom03" type="text" name="short_content" required="required">{{ $blog->short_content }}</textarea>
                                    <div class="valid-feedback">{{ __('validation.valid_feedback') }}</div>
                                    <div class="invalid-feedback">{{ __('validation.invalid_feedback') }}</div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-select" data-live-search="true"
                                        ...
                                        @foreach ($languages as $language)
                                            <option {{ $blog->language_id == $language->id ? 'selected'  : ''}}
