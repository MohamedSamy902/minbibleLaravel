                                ...
                                <tbody>
                                    <?php $__currentLoopData = $translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $translation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($translation->language->name); ?></td>

                                            <td>
                                                <div style="display: flex;">
                                                    <a class="btn btn-outline-primary-2x" style="margin:0 20px;"
                                                        href="<?php echo e(route('translations.edit', $translation->id)); ?>"><?php echo e(__('master.edit')); ?></a>

                                                    <form action="<?php echo e(route('translations.destroy', $translation->id)); ?>"
                                                        method="post">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed/Desktop/masterLaravel/resources/views/dashbord/translations/index.blade.php ENDPATH**/ ?>