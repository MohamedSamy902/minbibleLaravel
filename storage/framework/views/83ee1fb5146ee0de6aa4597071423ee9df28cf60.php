                                            ...
                                            <td>
                                                <div style="display: flex;">
                                                    <a class="btn btn-outline-primary-2x" style="margin:0 20px;"
                                                        href="<?php echo e(route('languages.edit', $language->id)); ?>"><?php echo e(__('master.edit')); ?></a>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed/Desktop/masterLaravel/resources/views/dashbord/languages/index.blade.php ENDPATH**/ ?>